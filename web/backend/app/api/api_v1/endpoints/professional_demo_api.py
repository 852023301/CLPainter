...
@router.get("/Professional_kline_brush", response_class=HTMLResponse)
async def Professional_kline_brush(request: Request):
    return templates.TemplateResponse(
        "index.html",
        {"request": request, "chart": draw_charts().render_embed()}
    )
