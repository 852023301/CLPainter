...
@router.get("/Professional_kline_chart", response_class=HTMLResponse)
async def Professional_kline_chart(request: Request):
    return templates.TemplateResponse(
        "index.html",
        {"request": request, "chart": draw_chart().render_embed()}
    )
